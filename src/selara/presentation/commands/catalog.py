...
SOCIAL_TRIGGER_TO_COMMAND_KEY: dict[str, TextCommandKey] = {
    ...
    "отдаться": "social_surrender",
    "отдайся": "social_surrender",
    ...
    "уебать": "social_uebat",
    "уеби": "social_uebat",
    "треснуть": "social_bonk",
    "трещни": "social_bonk",
    "треснь": "social_bonk",
    "лупануть": "social_smite",
    "лупани": "social_smite",
    "засветить": "social_clout",
    "засвети": "social_clout",
    "пригласить на чай": "social_teatime",
    "пригласи на чай": "social_teatime",
    "пригласить на свидание": "social_dateask",
    "пригласи на свидание": "social_dateask",
    "спеть серенаду": "social_serenade",
    "спой серенаду": "social_serenade",
    "подарить цветок": "social_giveflower",
    "подари цветок": "social_giveflower",
    "покормить": "social_feed",
    "покорми": "social_feed",
    "принести кофе": "social_givecoffee",
    "принеси кофе": "social_givecoffee",
    "покатать на спине": "social_piggyback",
    "покатай на спине": "social_piggyback",
    "закидать снегом": "social_snowball",
    "закидай снегом": "social_snowball",
    "кинуть снежком": "social_snowball",
    "кинь снежок": "social_snowball",
    "щёлкнуть по носу": "social_nosesnap",
    "щёлкни по носу": "social_nosesnap",
    "потрепать": "social_ruffle",
    ...
    "расстрелять": "social_shoot",
    "расстреляй": "social_shoot",
    "добить": "social_finish",
    "добей": "social_finish",
    "подбить": "social_down",
    "подбей": "social_down",
    "утопить": "social_drown",
    "утопи": "social_drown",
    "бухнуть": "social_booze",
    "бухни": "social_booze",
    "пленить": "social_capture",
    "плени": "social_capture",
    "присунуть": "social_thrust",
    "присунь": "social_thrust",
    "помолиться на": "social_pray",
    "помолись на": "social_pray",
    "зажарить": "social_roast",
    "зажарь": "social_roast",
    "промыть": "social_rinse",
    "промой": "social_rinse",
    "пожамкать попу": "social_squeezebutt",
    "пожамкай попу": "social_squeezebutt",
    "пожмякать": "social_squish",
    "пожмякай": "social_squish",
    "растерзать": "social_rend",
    "растерзай": "social_rend",
    "связать": "social_tie",
    "свяжи": "social_tie",
    "увести": "social_takeaway",
    "уведи": "social_takeaway",
    "провести оральную поддержку": "social_oralsupport",
    "окажи оральную поддержку": "social_oralsupport",
    "провести анальную поддержку": "social_analsupport",
    "окажи анальную поддержку": "social_analsupport",
}
...
SOCIAL_COMMAND_KEY_TO_ACTION: dict[TextCommandKey, str] = {
    ...
    "social_smite": "smite",
    "social_clout": "clout",
    "social_teatime": "teatime",
    "social_dateask": "dateask",
    "social_serenade": "serenade",
    "social_giveflower": "giveflower",
    "social_feed": "feed",
    "social_givecoffee": "givecoffee",
    "social_piggyback": "piggyback",
    "social_snowball": "snowball",
    ...
    "social_shoot": "shoot",
    "social_finish": "finish",
    "social_down": "down",
    "social_drown": "drown",
    "social_booze": "booze",
    "social_capture": "capture",
    "social_thrust": "thrust",
    "social_pray": "pray",
    "social_roast": "roast",
    "social_rinse": "rinse",
    "social_squeezebutt": "squeezebutt",
    "social_squish": "squish",
    "social_rend": "rend",
    "social_tie": "tie",
    "social_takeaway": "takeaway",
    "social_oralsupport": "oralsupport",
    "social_analsupport": "analsupport",
}
...
COMMAND_KEY_DEFAULT_SOURCE_TRIGGER: dict[TextCommandKey, str] = {
    ...
    "social_surrender": "отдаться",
    "social_gang": "пустить по кругу",
    "social_banghard": "оттрахать",
    "social_shovein": "засадить",
    "social_suck": "отсосать",
    "social_uebat": "уебать",
    "social_bonk": "треснуть",
    "social_smite": "лупануть",
    "social_clout": "засветить",
    "social_teatime": "пригласить на чай",
    "social_dateask": "пригласить на свидание",
    "social_serenade": "спеть серенаду",
    "social_giveflower": "подарить цветок",
    "social_feed": "покормить",
    "social_givecoffee": "принести кофе",
    "social_piggyback": "покатать на спине",
    "social_snowball": "закидать снегом",
    ...
    "social_shoot": "расстрелять",
    "social_finish": "добить",
    "social_down": "подбить",
    "social_drown": "утопить",
    "social_booze": "бухнуть",
    "social_capture": "пленить",
    "social_thrust": "присунуть",
    "social_pray": "помолиться на",
    "social_roast": "зажарить",
    "social_rinse": "промыть",
    "social_squeezebutt": "пожамкать попу",
    "social_squish": "пожмякать",
    "social_rend": "растерзать",
    "social_tie": "связать",
    "social_takeaway": "увести",
    "social_oralsupport": "провести оральную поддержку",
    "social_analsupport": "провести анальную поддержку",
}
