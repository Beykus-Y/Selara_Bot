...
_HELP_SECTION_TEXT: dict[str, str] = {
    ...
    "social": (
        ...
        "• Reply-действия: шлепнуть/сжечь/убить/трахнуть/соблазнить/засосать/провести ночь с/сесть на/ударить/обнять/поцеловать/пожать руку/дать пять/погладить/наступить/пощекотать/ткнуть/оттолкнуть/подмигнуть/потанцевать/поклониться/подбодрить/угостить/похвалить/наругать/дать кулак/отсосать/минет\n"
