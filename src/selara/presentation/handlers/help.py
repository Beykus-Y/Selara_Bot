...
_HELP_SECTION_TEXT: dict[str, str] = {
    ...
    "social": (
        ...
        "• Reply-действия: шлепнуть/убить/трахнуть/соблазнить/засосать/провести ночь с/ударить/обнять/поцеловать/пожать руку/дать пять/погладить/пощекотать/ткнуть/подмигнуть/потанцевать/поклониться/подбодрить/угостить/похвалить/дать кулак\n"
