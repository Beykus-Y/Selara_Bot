...
_SOCIAL_ACTION_CANONICAL: dict[str, str] = {
    ...
    "clobber": "приложить",
    "stamp": "припечатать",
    "headknock": "настучать по голове",
    "wallpin": "прижать к стене",
    "scruff": "схватить за шкирку",
    "windowthrow": "выкинуть в окно",
    "stairdump": "спустить с лестницы",
    "knockout": "отправить в нокаут",
    "faceslap": "дать леща",
    "wallop": "навалять",
    "smash": "вломить",
    "smear": "размазать",
    ...
    "flame": "захуесосить",
    "bully": "забуллить",
    "dominate": "задоминировать",
    "bossaround": "застроить",
    "shutdown": "осадить",
    "shutup": "заткнуть",
    "fuckoff": "послать нахуй",
    "evict": "выгнать",
    "purr": "помурлыкать",
    "nuzzle": "потереться",
    "cutesy": "поняшиться",
    "sobshoulder": "похныкать в плечо",
    "curlup": "свернуться рядом",
    "snuffle": "засопеть",
    "rumble": "поурчать",
    "nestle": "уткнуться",
    "sneakclose": "подлезть",
    "caress": "приласкать",
    "stareat": "залипнуть на",
    "hug": "обнять",
    "kiss": "поцеловать",
    ...
    "smite": "лупануть",
    "clout": "засветить",
    "teatime": "пригласить на чай",
    "dateask": "пригласить на свидание",
    "serenade": "спеть серенаду",
    "giveflower": "подарить цветок",
    "feed": "покормить",
    "givecoffee": "принести кофе",
    "piggyback": "покатать на спине",
    "snowball": "закидать снегом",
    "nosesnap": "щёлкнуть по носу",
    "ruffle": "потрепать",
    "play": "поиграть",
    "bbq": "пустить на шашлык",
    "revive": "воскресить",
    "chomp": "укусить",
    "givewine": "напоить",
    "warm": "согреть",
    "invitedance": "пригласить на танец",
    "dickwave": "поводить членом",
    "shoot": "расстрелять",
    "finish": "добить",
    "down": "подбить",
    "drown": "утопить",
    ...
    "roast": "зажарить",
    "rinse": "промыть",
    "squeezebutt": "пожамкать попу",
    "squish": "пожмякать",
    "rend": "растерзать",
    "tie": "связать",
    "takeaway": "увести",
    "oralsupport": "провести оральную поддержку",
    "analsupport": "провести анальную поддержку",
}
...
_SOCIAL_ACTION_TEMPLATES: dict[str, tuple[str, ...]] = {
    ...
    "fuck": (
        "🔥 | {actor} грубо трахнул(а) {target} без лишних нежностей.",
        "🔥 | {actor} засадил(а) {target} по самые яйца и не сбавил(а) темп.",
        "🔥 | {actor} натянул(а) {target} так, что стены услышали каждый стон.",
        "🔞 | {actor} ебал(а) {target} долго и без пауз, доведя до изнеможения.",
        "🔞 | {actor} вставил(а) {target} по самый конец и начал(а) двигать бёдрами.",
        "🔥 | {actor} трахал(а) {target} в нескольких позах подряд, не давая передышки.",
    ),
    "seduce": (
        "😈 | {actor} соблазнил(а) {target}, распустив руки там, где не просили.",
        "😈 | {actor} прижал(а) {target} к стене и провёл(вела) рукой прямо туда.",
        "😈 | {actor} шепнул(а) {target} на ухо такое, что тот(та) немедленно согласился(ась).",
        "😈 | {actor} сначала соблазнил(а) {target} взглядом, а потом — ртом.",
        "😈 | {actor} подсел(а) к {target}, запустил(а) руку под одежду и больше не останавливался(ась).",
        "😈 | {actor} довёл(вела) {target} до нужной кондиции и взял(а) своё.",
    ),
    "makeout": (
        "💋 | {actor} засосал(а) {target} так, что у того(той) подкосились ноги.",
        "💋 | {actor} засунул(а) язык в рот {target} и не торопился(ась) вытаскивать.",
        "💋 | {actor} тёрся(ась) о {target} ртом, языком и руками одновременно.",
        "💋 | {actor} поцеловал(а) {target} с таким напором, что одежда оказалась лишней.",
        "💋 | {actor} облапал(а) {target} при поцелуе так, что чат захлопнул глаза.",
        "💋 | {actor} буквально ел(а) рот {target}, не отпуская ни на секунду.",
    ),
    "night": (
        "🌙 | {actor} провёл(вела) ночь с {target} — от первого стона до рассвета.",
        "🌙 | {actor} трахал(а) {target} всю ночь в разных позах и с разным темпом.",
        "🌙 | {actor} и {target} занимались сексом несколько часов без остановки.",
        "🌙 | {actor} кончил(а) на {target} несколько раз за ночь и остался(ась) доволен(довольна).",
        "🌙 | {actor} не дал(а) {target} поспать — слишком был(а) занят(а) его(её) телом.",
        "🌙 | {actor} использовал(а) {target} всю ночь, пока оба не обессилели.",
    ),
    "siton": (
    ...
    "bend": (
        "😏 | {actor} нагнул(а) {target} и вошёл(вошла) сзади без предупреждения.",
        "😏 | {actor} перегнул(а) {target} через стол и засадил(а) в позе сзади.",
        "😏 | {actor} нагнул(а) {target} и двигал(а) бёдрами до самого конца.",
        "😏 | {actor} задрал(а) {target} к себе сзади и начал(а) ебать без церемоний.",
        "😏 | {actor} прижал(а) {target} лицом вниз и вошёл(вошла) так, как хотел(а).",
        "😏 | {actor} нагнул(а) {target} и отработал(а) по полной программе.",
    ),
    "kneel": (
        "🛐 | {actor} поставил(а) {target} на колени и поднёс(поднесла) член к его(её) лицу.",
        "🛐 | {actor} заставил(а) {target} встать на колени и открыть рот.",
        "🛐 | {actor} надавил(а) на плечи {target}, опустив(ши) его(её) до нужной высоты.",
        "🛐 | {actor} держал(а) {target} на коленях за волосы и двигал(а) бёдрами.",
        "🛐 | {actor} поставил(а) {target} на колени и кончил(а) на его(её) лицо.",
        "🛐 | {actor} стоял(а) над {target} на коленях и пользовался(ась) им(ею) в своё удовольствие.",
    ),
    "undress": (
        "🫦 | {actor} раздел(а) {target} догола и долго осматривал(а) результат.",
        "🫦 | {actor} сорвал(а) одежду с {target} и сразу полез(ла) руками куда надо.",
        "🫦 | {actor} медленно раздел(а) {target}, ощупывая каждый сантиметр тела.",
        "🫦 | {actor} оголил(а) {target} и не удержался(ась) — сразу начал(а) лизать.",
        "🫦 | {actor} раздел(а) {target}, провёл(вела) языком по груди и опустился(ась) ниже.",
        "🫦 | {actor} снял(а) с {target} всё до последнего и прижал(а) к себе голым(ой) телом.",
    ),
    "ravage": (
        "🔞 | {actor} выебал(а) {target} жёстко и глубоко, не щадя ни себя, ни его(её).",
        "🔞 | {actor} ебал(а) {target} так яростно, что кровать ходила ходуном.",
        "🔞 | {actor} разъебал(а) {target} в несколько дыр подряд без остановки.",
        "🔞 | {actor} трахал(а) {target} с такой силой, что тот(та) потерял(а) счёт оргазмам.",
        "🔞 | {actor} не оставил(а) {target} живого места — выебал(а) во всех позах подряд.",
        "🔞 | {actor} просто уничтожил(а) {target} в постели — жёстко, грязно и без жалости.",
    ),
    "hit": (
    ...
    "whack": (
        "👊 | {actor} с размаху вмазал(а) {target}.",
        "👊 | {actor} отвесил(а) {target} такой вмазон, что аж воздух хрустнул.",
        "👊 | {actor} коротко и жёстко вмазал(а) {target} без лишних слов.",
        "👊 | {actor} так вмазал(а) {target}, будто давно держал(а) это в запасе.",
    ),
    "crack": (
        "💣 | {actor} въебал(а) {target} так, что чат на секунду стих.",
        "💣 | {actor} от души въебал(а) {target} без всякой дипломатии.",
        "💣 | {actor} выдал(а) {target} настолько злой удар, что даже стены напряглись.",
        "💣 | {actor} въебал(а) {target} с таким звуком, будто начался финальный раунд.",
    ),
    "beatup": (
        "🥊 | {actor} жёстко отпиздил(а) {target}.",
        "🥊 | {actor} выдал(а) {target} такую серию пиздюлей, что аж эхо пошло.",
        "🥊 | {actor} знатно отпиздил(а) {target} без пауз и жалости.",
        "🥊 | {actor} устроил(а) {target} полноценный разъёб по законам уличного боевика.",
    ),
    "maul": (
        "🥊 | {actor} основательно отмудохал(а) {target}.",
        "🥊 | {actor} так отмудохал(а) {target}, что остатки пафоса осыпались на пол.",
        "🥊 | {actor} устроил(а) {target} очень грубый урок без права на апелляцию.",
        "🥊 | {actor} вцепился(ась) в {target} и отмудохал(а) его(её) по полной программе.",
    ),
    "stomp": (
        "🦵 | {actor} запинал(а) {target}.",
        "🦵 | {actor} устроил(а) для {target} злую серию пинков без передышки.",
        "🦵 | {actor} так бодро запинал(а) {target}, что пыль поднялась.",
        "🦵 | {actor} отправил(а) {target} в мемный ураган пинков.",
        "🦵 | {actor} прошёлся(лась) по {target} с целым каскадом пинков.",
    ),
    "manhandle": (
        "🪓 | {actor} грубо оттаскал(а) {target} по всей площадке.",
        "🪓 | {actor} вцепился(ась) в {target} и протащил(а) его(её) через весь хаос.",
        "🪓 | {actor} так оттаскал(а) {target}, что тот(та) едва поспевал(а) за происходящим.",
        "🪓 | {actor} без церемоний протащил(а) {target} туда, куда посчитал(а) нужным.",
    ),
    "restrain": (
        "🪢 | {actor} ловко скрутил(а) {target}.",
        "🪢 | {actor} завернул(а) {target} в такой захват, что дёргаться стало поздно.",
        "🪢 | {actor} жёстко скрутил(а) {target}, оставив(ши) только возмущение.",
        "🪢 | {actor} уложил(а) {target} на контроль и быстро скрутил(а) его(её).",
    ),
    "throw": (
        "🪃 | {actor} швырнул(а) {target} в сторону.",
        "🪃 | {actor} с явным раздражением швырнул(а) {target}, будто тот(та) был(а) лишним предметом.",
        "🪃 | {actor} взял(а) и просто швырнул(а) {target} без всякой жалости.",
        "🪃 | {actor} метнул(а) {target} с таким настроем, будто репетировал(а) это заранее.",
    ),
    "clobber": (
        "🔨 | {actor} хорошенько приложил(а) {target}.",
        "🔨 | {actor} приложил(а) {target} так чётко, что спорить стало бессмысленно.",
        "🔨 | {actor} выдал(а) {target} такой прилож, что у всех синхронно дёрнулся глаз.",
        "🔨 | {actor} сочно приложил(а) {target} и остался(ась) весьма доволен(на).",
    ),
    "stamp": (
        "🧱 | {actor} припечатал(а) {target} так, что тот(та) чуть не слился(ась) с поверхностью.",
        "🧱 | {actor} впечатал(а) {target} в ближайшую реальность с максимальной убедительностью.",
        "🧱 | {actor} с размаху припечатал(а) {target}, не оставив места для возражений.",
        "🧱 | {actor} так впечатал(а) {target}, что даже декорации вздрогнули.",
    ),
    "headknock": (
        "🥁 | {actor} настучал(а) {target} по голове.",
        "🥁 | {actor} отмерил(а) {target} серию увесистых подзатыльников.",
        "🥁 | {actor} проверил(а) звонкость макушки {target} несколькими ударами.",
        "🥁 | {actor} выстучал(а) по голове {target} тревожный марш.",
        "🥁 | {actor} устроил(а) на голове {target} целый барабанный соляк.",
    ),
    "wallpin": (
        "🧱 | {actor} жёстко прижал(а) {target} к стене.",
        "🧱 | {actor} вжал(а) {target} в стену одним резким движением.",
        "🧱 | {actor} зафиксировал(а) {target} у стены так, что дышать стало громче.",
        "🧱 | {actor} прижал(а) {target} к стене с очень недобрым выражением лица.",
    ),
    "scruff": (
        "🐺 | {actor} схватил(а) {target} за шкирку.",
        "🐺 | {actor} подцепил(а) {target} за шкирку и резко выдернул(а) из ситуации.",
        "🐺 | {actor} жёстко взял(а) {target} за шкирку, оборвав(ши) весь пафос.",
        "🐺 | {actor} с хищным спокойствием ухватил(а) {target} за шкирку и потащил(а).",
    ),
    "windowthrow": (
        "🪟 | {actor} без разговоров выкинул(а) {target} в окно.",
        "🪟 | {actor} так резко отправил(а) {target} в окно, что никто не успел моргнуть.",
        "🪟 | {actor} схватил(а) {target} и вышвырнул(а) прямиком в оконный проём.",
        "🪟 | {actor} решил(а), что {target} сегодня познакомится с видом снаружи поближе.",
    ),
    "stairdump": (
        "🪜 | {actor} спустил(а) {target} с лестницы самым неприятным способом.",
        "🪜 | {actor} отправил(а) {target} вниз по ступеням без права зацепиться за перила.",
        "🪜 | {actor} так жёстко спустил(а) {target} с лестницы, что эхо пошло по этажам.",
        "🪜 | {actor} выдал(а) {target} экспресс-маршрут по лестнице строго вниз.",
    ),
    "knockout": (
        "🥴 | {actor} отправил(а) {target} в нокаут.",
        "🥴 | {actor} вырубил(а) {target} так чисто, будто это был учебный ролик.",
        "🥴 | {actor} уложил(а) {target} в нокаут одним убедительным попаданием.",
        "🥴 | {actor} погасил(а) {target} так быстро, что зрители не поняли, когда всё закончилось.",
    ),
    "faceslap": (
        "🖐 | {actor} отвесил(а) {target} леща.",
        "🖐 | {actor} зарядил(а) {target} таким лещом, что щёки вспомнили детство.",
        "🖐 | {actor} выдал(а) {target} сочного леща по всем канонам жанра.",
        "🖐 | {actor} не сдержался(ась) и смачно дал(а) {target} леща.",
    ),
    "wallop": (
        "💥 | {actor} навалял(а) {target}.",
        "💥 | {actor} так навалял(а) {target}, что аргументы закончились мгновенно.",
        "💥 | {actor} устроил(а) {target} короткий, но очень доходчивый разнос.",
        "💥 | {actor} выдал(а) {target} увесистую порцию люлей.",
        "💥 | {actor} навалял(а) {target} с энергией финального босса.",
    ),
    "smash": (
        "🚨 | {actor} вломил(а) {target}.",
        "🚨 | {actor} зарядил(а) {target} так, будто шёл последний раунд.",
        "🚨 | {actor} выдал(а) {target} такое вломление, что чат хрюкнул.",
        "🚨 | {actor} приложил(а) {target} с максимальной убедительностью.",
        "🚨 | {actor} вломил(а) {target} жёстко, но по-мемному.",
    ),
    "smear": (
        "🩸 | {actor} размазал(а) {target} по месту действия.",
        "🩸 | {actor} так размазал(а) {target}, что собирать самооценку пришлось бы по кускам.",
        "🩸 | {actor} превратил(а) {target} в наглядное пособие по доминированию.",
        "🩸 | {actor} с холодным лицом размазал(а) {target} по всей сцене.",
    ),
    "wreck": (
        "💣 | {actor} разъебал(а) {target} подчистую.",
        "💣 | {actor} разнёс(разнесла) {target} так, что от спора осталась одна пыль.",
        "💣 | {actor} устроил(а) {target} полный разнос без шанса на камбэк.",
        "💣 | {actor} буквально разъебал(а) {target} и пошёл(пошла) дальше, будто ничего не было.",
    ),
    "humiliate": (
        "🫵 | {actor} публично унизил(а) {target}.",
        "🫵 | {actor} опустил(а) {target} так низко, что даже чат притих.",
        "🫵 | {actor} устроил(а) {target} демонстративное унижение на глазах у всех.",
        "🫵 | {actor} втоптал(а) достоинство {target} в пол одним проходом.",
    ),
    "ridicule": (
        "😂 | {actor} засмеял(а) {target}.",
        "😂 | {actor} поднял(а) {target} на смех так, что хохот прокатился по всему чату.",
        "😂 | {actor} выставил(а) {target} ходячим анекдотом на ближайшие пять минут.",
        "😂 | {actor} засмеял(а) {target} с такой лёгкостью, будто это было неизбежно.",
    ),
    "flame": (
        "☠️ | {actor} жёстко захуесосил(а) {target}.",
        "☠️ | {actor} вывалил(а) на {target} такой поток хейта, что искры пошли из текста.",
        "☠️ | {actor} раскатал(а) {target} словесно и без права на ответную реплику.",
        "☠️ | {actor} устроил(а) {target} словесный крематорий с матерком и огоньком.",
    ),
    "bully": (
        "🧷 | {actor} начал(а) жёстко буллить {target}.",
        "🧷 | {actor} взял(а) {target} в оборот и не дал(а) продохнуть ни секунды.",
        "🧷 | {actor} затравил(а) {target} так буднично, будто это был рабочий план на день.",
        "🧷 | {actor} устроил(а) {target} полноценный школьный режим прессинга.",
    ),
    "dominate": (
        "♟ | {actor} задоминировал(а) {target}.",
        "♟ | {actor} полностью продавил(а) {target}, оставив(ши) ему(ей) только молча соглашаться.",
        "♟ | {actor} навис(нависла) над {target} с таким превосходством, что спор умер на месте.",
        "♟ | {actor} показал(а) {target}, кто здесь задаёт темп и правила.",
    ),
    "bossaround": (
        "📏 | {actor} быстро застроил(а) {target}.",
        "📏 | {actor} поставил(а) {target} на место жёстким тоном и короткими фразами.",
        "📏 | {actor} выдал(а) {target} такой разбор, что тот(та) моментально выпрямился(ась).",
        "📏 | {actor} застроил(а) {target} без единого лишнего движения.",
    ),
    "shutdown": (
        "❄️ | {actor} жёстко осадил(а) {target}.",
        "❄️ | {actor} сбил(а) спесь с {target} одним точным замечанием.",
        "❄️ | {actor} так осадил(а) {target}, что продолжение фразы потерялось по дороге.",
        "❄️ | {actor} охладил(а) пыл {target} мгновенно и безжалостно.",
    ),
    "shutup": (
        "🤫 | {actor} грубо заткнул(а) {target}.",
        "🤫 | {actor} оборвал(а) {target} на полуслове и даже не поморщился(ась).",
        "🤫 | {actor} так резко заткнул(а) {target}, что повисла неловкая тишина.",
        "🤫 | {actor} дал(а) понять {target}, что говорить ему(ей) уже никто не разрешал.",
    ),
    "fuckoff": (
        "🖕 | {actor} послал(а) {target} нахуй.",
        "🖕 | {actor} отправил(а) {target} в пешее эротическое без малейшего сомнения.",
        "🖕 | {actor} настолько прямо послал(а) {target}, что смягчать тут уже нечего.",
        "🖕 | {actor} хладнокровно послал(а) {target} нахуй и закрыл(а) вопрос.",
    ),
    "evict": (
        "🚷 | {actor} выгнал(а) {target}.",
        "🚷 | {actor} выставил(а) {target} вон без обсуждений.",
        "🚷 | {actor} прогнал(а) {target} так быстро, что тот(та) не успел(а) возмутиться.",
        "🚷 | {actor} чётко обозначил(а), что {target} здесь больше не ждут.",
    ),
    "purr": (
        "🐾 | {actor} довольно помурлыкал(а) рядом с {target}.",
        "🐾 | {actor} устроил(а) для {target} мягкое мурлыкающее сопровождение.",
        "🐾 | {actor} замурлыкал(а) так уютно, что {target} невольно расслабился(ась).",
        "🐾 | {actor} прижался(ась) к {target} и тихо помурлыкал(а).",
        "🐾 | {actor} включил(а) режим довольного кота и помурлыкал(а) для {target}.",
    ),
    "nuzzle": (
        "🐈 | {actor} нежно потёрся(лась) об {target}.",
        "🐈 | {actor} довольно прильнул(а) к {target} и потёрся(лась) щекой.",
        "🐈 | {actor} устроил(а) {target} маленький приступ кошачьей нежности.",
        "🐈 | {actor} мягко потёрся(лась) об {target}, явно требуя внимания.",
    ),
    "cutesy": (
        "🌸 | {actor} мило поняшился(ась) с {target}.",
        "🌸 | {actor} включил(а) режим абсолютной няшности рядом с {target}.",
        "🌸 | {actor} развёл(развела) вокруг {target} такую милоту, что сопротивление стало бесполезным.",
        "🌸 | {actor} поняшился(ась) с {target} до критического уровня умиления.",
    ),
    "sobshoulder": (
        "🥺 | {actor} тихо похныкал(а) в плечо {target}.",
        "🥺 | {actor} уткнулся(ась) в плечо {target} и начал(а) жалобно хныкать.",
        "🥺 | {actor} доверил(а) плечу {target} весь свой драматизм сразу.",
        "🥺 | {actor} похныкал(а) в плечо {target}, будто это самое безопасное место в мире.",
    ),
    "curlup": (
        "🧶 | {actor} свернулся(ась) рядом с {target}.",
        "🧶 | {actor} устроился(ась) клубочком возле {target}.",
        "🧶 | {actor} тихо свернулся(ась) рядом, явно выбирая {target} как зону комфорта.",
        "🧶 | {actor} занял(а) место рядом с {target} в самом уютном виде из возможных.",
    ),
    "snuffle": (
        "😴 | {actor} уютно засопел(а) рядом с {target}.",
        "😴 | {actor} устроился(ась) так удобно, что рядом с {target} сразу послышалось сопение.",
        "😴 | {actor} начал(а) сонно сопеть возле {target}, будто всё наконец стало хорошо.",
        "😴 | {actor} засопел(а) так тихо и мирно, что даже шум вокруг отступил.",
    ),
    "rumble": (
        "🫧 | {actor} мягко поурчал(а) для {target}.",
        "🫧 | {actor} пустил(а) низкое довольное урчание прямо рядом с {target}.",
        "🫧 | {actor} лениво поурчал(а), явно наслаждаясь близостью {target}.",
        "🫧 | {actor} окутал(а) {target} тёплым урчанием вместо слов.",
    ),
    "nestle": (
        "🤍 | {actor} уткнулся(ась) в {target}.",
        "🤍 | {actor} спрятал(а) лицо в {target}, будто так спокойнее.",
        "🤍 | {actor} тихо прижался(ась) к {target} и уткнулся(ась), не желая отпускать момент.",
        "🤍 | {actor} выбрал(а) {target} своей безопасной точкой и просто уткнулся(ась) в него(неё).",
    ),
    "sneakclose": (
        "🐾 | {actor} незаметно подлез(ла) к {target}.",
        "🐾 | {actor} ловко поднырнул(а) поближе к {target} и занял(а) тёплое место.",
        "🐾 | {actor} подлез(ла) к {target} с таким видом, будто так и должно быть.",
        "🐾 | {actor} тихо втиснулся(ась) поближе к {target}, не спрашивая разрешения у атмосферы.",
    ),
    "caress": (
        "🫶 | {actor} нежно приласкал(а) {target}.",
        "🫶 | {actor} окутал(а) {target} мягкой лаской и вниманием.",
        "🫶 | {actor} бережно провёл(вела) рукой по {target}, успокаивая одним касанием.",
        "🫶 | {actor} приласкал(а) {target} так аккуратно, будто тот(та) был(а) хрупким сокровищем.",
    ),
    "stareat": (
        "👀 | {actor} залип(ла) на {target}.",
        "👀 | {actor} так уставился(ась) на {target}, будто весь остальной мир отключили.",
        "👀 | {actor} завис(ла) взглядом на {target} и явно не собирался(ась) отвлекаться.",
        "👀 | {actor} поймал(а) {target} взглядом и безнадёжно залип(ла).",
    ),
    "hug": (
    ...
    "bite": (
        "🦷 | {actor} куснул(а) {target}.",
        "🦷 | {actor} оставил(а) на {target} мемный кусь.",
        "🦷 | {actor} слегка тяпнул(а) {target} ради атмосферы.",
        "🦷 | {actor} не удержался(ась) и куснул(а) {target}.",
    ),
    "kick": (
        "🦵 | {actor} пнул(а) {target}.",
        "🦵 | {actor} выдал(а) {target} бодрый пинок.",
        "🦵 | {actor} отправил(а) {target} в движение хорошим пинком.",
        "🦵 | {actor} пнул(а) {target} с чисто мемным настроем.",
    ),
    "pinch": (
        "🤏 | {actor} ущипнул(а) {target}.",
        "🤏 | {actor} проверил(а), не сон ли это, и ущипнул(а) {target}.",
        "🤏 | {actor} оставил(а) {target} небольшой, но выразительный щипок.",
        "🤏 | {actor} ущипнул(а) {target} ради драматического эффекта.",
    ),
    "squeeze": (
        "🫂 | {actor} прижал(а) {target} к себе.",
        "🫂 | {actor} крепко прижал(а) к себе {target}.",
        "🫂 | {actor} потискал(а) {target} без шанса на побег.",
        "🫂 | {actor} сгрёб(ла) {target} в тесные объятия.",
    ),
    "step": (
    ...
    "comfort": (
        "🫶 | {actor} утешил(а) {target}.",
        "🫶 | {actor} нашёл(нашла) для {target} правильные слова поддержки.",
        "🫶 | {actor} мягко утешил(а) {target} и помог(ла) выдохнуть.",
        "🫶 | {actor} дал(а) {target} немного тепла и спокойствия.",
    ),
    "calm": (
        "🧘 | {actor} успокоил(а) {target}.",
        "🧘 | {actor} помог(ла) {target} собраться и перестать кипеть.",
        "🧘 | {actor} сбил(а) градус эмоций у {target}.",
        "🧘 | {actor} сказал(а) {target}: «Спокойно, всё под контролем».",
    ),
    "protect": (
        "🛡 | {actor} защитил(а) {target}.",
        "🛡 | {actor} встал(а) на защиту {target}.",
        "🛡 | {actor} прикрыл(а) {target} собой от всего чата.",
        "🛡 | {actor} обозначил(а), что {target} сегодня под его(её) защитой.",
    ),
    "carry": (
        "💪 | {actor} поднял(а) {target} на руки.",
        "💪 | {actor} легко подхватил(а) {target} на руки.",
        "💪 | {actor} взял(а) на руки {target} и унёс(унесла) весь пафос с собой.",
        "💪 | {actor} эффектно поднял(а) {target} на руки, будто это финал ромкома.",
    ),
    "drag": (
        "🪝 | {actor} утащил(а) {target} в сторону.",
        "🪝 | {actor} бесцеремонно уволок(ла) {target} по своим делам.",
        "🪝 | {actor} схватил(а) {target} и утащил(а) из эпицентра событий.",
        "🪝 | {actor} оперативно утащил(а) {target}, не оставив права голоса.",
    ),
    "shoo": (
        "🚪 | {actor} выпроводил(а) {target} за дверь.",
        "🚪 | {actor} вежливо, но настойчиво выставил(а) {target} за дверь.",
        "🚪 | {actor} отправил(а) {target} проветриться за пределы сцены.",
        "🚪 | {actor} обозначил(а) выход для {target} очень наглядно.",
    ),
    "hurlout": (
        "🗑 | {actor} грубо вышвернул(а) {target} нахрен из кадра.",
        "🗑 | {actor} схватил(а) {target} и вышвырнул(а) к чертям без разговоров.",
        "🗑 | {actor} пинком вышвырнул(а) {target} со сцены с максимально злым лицом.",
        "🗑 | {actor} так жёстко вышвернул(а) {target}, что дверь ещё дрожит.",
        "🗑 | {actor} отправил(а) {target} вон с размаху и без капли вежливости.",
    ),
    "wink": (
    ...
    "congrats": (
        "🎉 | {actor} поздравил(а) {target}.",
        "🎉 | {actor} устроил(а) для {target} маленький победный момент.",
        "🎉 | {actor} вручил(а) {target} пачку тёплых поздравлений.",
        "🎉 | {actor} объявил(а), что {target} сегодня заслуживает оваций.",
    ),
    "wrap": (
        "🛌 | {actor} укрыл(а) {target} пледом.",
        "🛌 | {actor} заботливо укутал(а) {target}.",
        "🛌 | {actor} завернул(а) {target} в уют и спокойствие.",
        "🛌 | {actor} убедился(ась), что {target} теперь в тепле.",
    ),
    "scold": (
    ...
    "take": (
        "🔞 | {actor} взял(а) {target} силой, раздвинув ноги и войдя без разговоров.",
        "🔞 | {actor} прижал(а) {target} и вставил(а) столько, сколько влезло.",
        "🔞 | {actor} взял(а) {target} прямо там, где застал(а), — грубо и глубоко.",
        "🔞 | {actor} повалил(а) {target} и взял(а) его(её) тело без лишних слов.",
        "🔞 | {actor} овладел(а) {target} полностью — ртом, руками и членом.",
        "🔞 | {actor} взял(а) {target} именно так, как хотел(а), — до полного удовлетворения.",
    ),
    "have": (
        "🔞 | {actor} поимел(а) {target} во все отверстия по очереди.",
        "🔞 | {actor} использовал(а) {target} как секс-объект — грубо и с удовольствием.",
        "🔞 | {actor} ебал(а) {target} до тех пор, пока сам(а) не кончил(а).",
        "🔞 | {actor} поимел(а) {target} глубоко и долго, не спрашивая удобства.",
        "🔞 | {actor} трахнул(а) {target} в рот и в жопу — не стал(а) выбирать.",
        "🔞 | {actor} имел(а) {target} с наслаждением: медленно сначала, потом до конца.",
    ),
    "impale": (
        "🔞 | {actor} насадил(а) {target} на член до упора.",
        "🔞 | {actor} вогнал(а) {target} на себя целиком и начал(а) двигать вверх-вниз.",
        "🔞 | {actor} насадил(а) {target} так глубоко, что у того(той) перехватило дыхание.",
        "🔞 | {actor} резко насадил(а) {target} до основания и держал(а) там.",
        "🔞 | {actor} посадил(а) {target} на член и не давал(а) слезть, пока оба не кончили.",
        "🔞 | {actor} насаживал(а) {target} снова и снова, задавая всё более жёсткий темп.",
    ),
    "trap": (
        "🔞 | {actor} зажал(а) {target} между ног и начал(а) тереться об него(неё).",
        "🔞 | {actor} прижал(а) {target} к стене, задрал(а) ногу и вошёл(вошла).",
        "🔞 | {actor} зажал(а) {target} так, что тот(та) не мог(ла) двигаться — и воспользовался(ась) этим.",
        "🔞 | {actor} захватил(а) {target} в объятия с входом сзади и не отпускал(а).",
        "🔞 | {actor} придавил(а) {target} своим весом и начал(а) двигаться.",
        "🔞 | {actor} держал(а) {target} зажатым(ой) и ебал(а) методично и глубоко.",
    ),
    "floor": (
        "🔞 | {actor} завалил(а) {target} на пол и сразу залез(ла) между ног.",
        "🔞 | {actor} опрокинул(а) {target} и вошёл(вошла) прямо там, на полу.",
        "🔞 | {actor} повалил(а) {target} и ебал(а) сверху, придавив всем весом.",
        "🔞 | {actor} бросил(а) {target} на пол и трахнул(а) так, что линолеум пострадал.",
        "🔞 | {actor} завалил(а) {target} лицом вниз и взял(а) сзади без предупреждения.",
        "🔞 | {actor} уложил(а) {target} и занял(а) его(её) тело во всех доступных позах.",
    ),
    "spread": (
        "🔞 | {actor} раздвинул(а) ноги {target} и зашёл(зашла) без церемоний.",
        "🔞 | {actor} разложил(а) {target} и начал(а) лизать до первого стона.",
        "🔞 | {actor} широко раздвинул(а) {target} и вошёл(вошла) медленно, до упора.",
        "🔞 | {actor} разложил(а) {target} на краю кровати и трахал(а) стоя.",
        "🔞 | {actor} раздвинул(а) {target} пошире и занялся(ась) ртом и руками одновременно.",
        "🔞 | {actor} разложил(а) {target} и ебал(а) до тех пор, пока у него(неё) не подкосились ноги.",
    ),
    "surrender": (
        "🎀 | {actor} отдался(ась) {target} полностью, без остатка и без сопротивления.",
        "🎀 | {actor} сам(а) разделся(ась) перед {target} и покорно отдался(ась).",
        "🎀 | {actor} прижался(ась) к {target} и прошептал(а) «бери меня», отдаваясь без остатка.",
        "🎀 | {actor} опустился(ась) на колени перед {target} и отдался(ась) телом и голосом.",
        "🎀 | {actor} безропотно лёг(легла) под {target} и отдался(ась) на его(её) усмотрение.",
        "🎀 | {actor} растворился(ась) в объятиях {target}, полностью отдав себя в его(её) власть.",
    ),
    "gang": (
        "🔞 | {actor} организовал(а) для {target} групповой секс без права выбора.",
        "🔞 | {actor} пустил(а) {target} по кругу — каждый брал(а) свою очередь.",
        "🔞 | {actor} выставил(а) {target} на общее пользование: спереди, сзади, в рот.",
        "🔞 | {actor} сделал(а) {target} центром грязной оргии без пауз и нежностей.",
        "🔞 | {actor} устроил(а) {target} сразу троих: в рот, во влагалище и в задний проход.",
        "🔞 | {actor} пустил(а) {target} по рукам, пока каждый не получил(а) своё.",
    ),
    "banghard": (
        "🔞 | {actor} оттрахал(а) {target} так жёстко, что тот(та) охрип(ла) от стонов.",
        "🔞 | {actor} ебал(а) {target} с полной отдачей — быстро, глубоко и без пощады.",
        "🔞 | {actor} долбил(а) {target} в самый конец снова и снова, не замедляясь.",
        "🔞 | {actor} оттрахал(а) {target} во все дыры по очереди и без передышки.",
        "🔞 | {actor} ебал(а) {target} так сильно, что у него(неё) подкашивались ноги.",
        "🔞 | {actor} жёстко и методично оттрахал(а) {target} до полного изнеможения.",
    ),
    "shovein": (
        "🔞 | {actor} резко вошёл(вошла) в {target} до самого основания.",
        "🔞 | {actor} засадил(а) {target} по рукоять с одного движения.",
        "🔞 | {actor} грубо ввёл(ввела) член в {target} и начал(а) двигаться без прелюдии.",
        "🔞 | {actor} резко засунул(а) {target} полностью и остался(ась) внутри.",
        "🔞 | {actor} вогнал(а) в {target} всё до конца и начал(а) ебать без остановки.",
        "🔞 | {actor} вошёл(вошла) в {target} рывком и держал(а) темп до последнего.",
    ),
    "suck": (
        "🍓 | {actor} взял(а) член {target} в рот и сосал(а) медленно, до основания.",
        "🍓 | {actor} опустился(ась) на колени перед {target} и сделал(а) глубокий минет.",
        "🍓 | {actor} сосал(а) {target} так старательно, что тот(та) кончил(а) в рот.",
        "🍓 | {actor} облизал(а) {target} снизу доверху, а потом полностью взял(а) в рот.",
        "🍓 | {actor} глубоко засосал(а) {target}, не давая вздохнуть.",
        "🍓 | {actor} работал(а) ртом на {target} без остановки, пока тот(та) не кончил(а).",
    ),
    "uebat": (
        "💥 | {actor} смачно уебал(а) {target}.",
        "💥 | {actor} уебал(а) {target} так, что эхо пошло по чату.",
        "💥 | {actor} с размаху уебал(а) {target} и не собирается извиняться.",
        "💥 | {actor} уебал(а) {target} от всей души — без предупреждений.",
    ),
    "bonk": (
        "🔔 | {actor} треснул(а) {target} по лбу.",
        "🔔 | {actor} звонко треснул(а) {target} и удовлетворился(ась).",
        "🔔 | {actor} прицелился(ась) и треснул(а) {target} точно в темечко.",
        "🔔 | {actor} треснул(а) {target} так задорно, что звук получился мемным.",
    ),
    "smite": (
        "⚡ | {actor} лупанул(а) {target}.",
        "⚡ | {actor} от всей широты душевной лупанул(а) {target}.",
        "⚡ | {actor} лупанул(а) {target} с таким воодушевлением, что чат притих.",
        "⚡ | {actor} лупанул(а) {target} без колебаний и с чистой совестью.",
    ),
    "clout": (
        "👁️ | {actor} засветил(а) {target} прямо в глаз.",
        "👁️ | {actor} засветил(а) {target} так чётко, что оба почувствовали момент.",
        "👁️ | {actor} аккуратно и целенаправленно засветил(а) {target}.",
        "👁️ | {actor} резко засветил(а) {target} и даже не поморщился(ась).",
    ),
    "teatime": (
        "☕ | {actor} пригласил(а) {target} на чай.",
        "☕ | {actor} завёл(а) чайник и позвал(а) {target} в гости.",
        "☕ | {actor} поставил(а) кружку перед {target}: «Чай будешь?»",
        "☕ | {actor} устроил(а) для {target} уютные посиделки за чаем без повода.",
    ),
    "dateask": (
        "💌 | {actor} пригласил(а) {target} на свидание.",
        "💌 | {actor} решился(ась) и пригласил(а) {target} на свидание.",
        "💌 | {actor} протянул(а) {target} записку: «Пойдёшь со мной на свидание?»",
        "💌 | {actor} собрал(а) смелость и позвал(а) {target} на свидание.",
    ),
    "serenade": (
        "🎶 | {actor} спел(а) серенаду для {target}.",
        "🎶 | {actor} достал(а) гитару и запел(а) серенаду прямо под окном {target}.",
        "🎶 | {actor} выступил(а) перед {target} с романтической серенадой.",
        "🎶 | {actor} закрыл(а) глаза и нежно запел(а) серенаду для {target}.",
    ),
    "giveflower": (
        "🌸 | {actor} подарил(а) {target} цветок.",
        "🌸 | {actor} протянул(а) {target} цветок с самым невинным видом.",
        "🌸 | {actor} появился(ась) с букетом и вручил(а) его {target}.",
        "🌸 | {actor} смущённо преподнёс(ла) {target} один единственный цветок.",
    ),
    "feed": (
        "🍜 | {actor} накормил(а) {target}.",
        "🍜 | {actor} поставил(а) перед {target} тарелку и убедился(ась), что тот(та) поел(а).",
        "🍜 | {actor} приготовил(а) еду и накормил(а) {target} до отвала.",
        "🍜 | {actor} не спросил(а), а просто накормил(а) {target}.",
    ),
    "givecoffee": (
        "☕ | {actor} принёс(ла) {target} кофе.",
        "☕ | {actor} молча поставил(а) кружку кофе перед {target}.",
        "☕ | {actor} появился(ась) с кофе именно тогда, когда {target} нужна была пауза.",
        "☕ | {actor} вручил(а) {target} кофе, не требуя ничего взамен.",
    ),
    "piggyback": (
        "🐎 | {actor} покатал(а) {target} на спине.",
        "🐎 | {actor} присел(а) и предложил(а) {target} прокатиться на спине.",
        "🐎 | {actor} легко усадил(а) {target} на спину и помчался(ась) вперёд.",
        "🐎 | {actor} прокатил(а) {target} на спине с полной серьёзностью.",
    ),
    "snowball": (
        "❄️ | {actor} закидал(а) {target} снежками.",
        "❄️ | {actor} метнул(а) снежок прямо в {target}.",
        "❄️ | {actor} устроил(а) для {target} снежную атаку без предупреждения.",
        "❄️ | {actor} так забросал(а) {target} снежками, что тот(та) не успел(а) увернуться.",
    ),
    "nosesnap": (
        "👃 | {actor} щёлкнул(а) {target} по носу.",
        "👃 | {actor} прицелился(ась) и метко щёлкнул(а) {target} по носу.",
        "👃 | {actor} нежно, но выразительно щёлкнул(а) {target} по носу.",
        "👃 | {actor} щёлкнул(а) по носу {target} — просто потому что мог(ла).",
    ),
    "ruffle": (
        "🖐 | {actor} потрепал(а) {target} по голове.",
        "🖐 | {actor} взлохматил(а) волосы {target} с дружеской бесцеремонностью.",
        "🖐 | {actor} потрепал(а) {target} по вихрам и пошёл(пошла) дальше.",
        "🖐 | {actor} ласково взъерошил(а) волосы {target}.",
    ),
    "play": (
        "🎮 | {actor} предложил(а) {target} поиграть.",
        "🎮 | {actor} затащил(а) {target} в очередную игру без права отказа.",
        "🎮 | {actor} и {target} решили скоротать время за игрой.",
        "🎮 | {actor} поиграл(а) с {target} и это было честно весело.",
    ),
    "bbq": (
        "🔥 | {actor} пустил(а) {target} на шашлык. Пахнет вкусно.",
        "🍖 | {actor} решил(а), что {target} сегодня будет в меню.",
        "🔥 | {actor} уже разжигает угли — {target} смотрит с нехорошим предчувствием.",
        "🍢 | {actor} деловито насадил(а) {target} на шампур. Мариновать будем или сразу?",
    ),
    "revive": (
        "✨ | {actor} воскресил(а) {target}. Добро пожаловать обратно.",
        "💫 | {actor} вернул(а) {target} из небытия — тот(та) явно удивлён(а).",
        "🌟 | {actor} снова вытащил(а) {target} на этот свет. И зачем?",
        "⚡ | {actor} воскресил(а) {target} одним эпичным жестом.",
    ),
    "chomp": (
        "😬 | {actor} цапнул(а) {target} всерьёз.",
        "🦷 | {actor} укусил(а) {target} без предупреждения и без сожалений.",
        "😤 | {actor} вцепился(ась) зубами в {target} — не насмерть, но ощутимо.",
        "🦴 | {actor} укусил(а) {target} с таким видом, будто так и надо.",
    ),
    "givewine": (
        "🍷 | {actor} налил(а) {target} и молча подвинул(а) бокал.",
        "🥂 | {actor} напоил(а) {target} — теперь разговор пойдёт легче.",
        "🍷 | {actor} поставил(а) перед {target} бокал с видом знатока.",
        "🥃 | {actor} напоил(а) {target}. Что будет дальше — отдельная история.",
    ),
    "warm": (
        "🔆 | {actor} согрел(а) {target}. Чуть теплее стало.",
        "🧣 | {actor} укутал(а) {target} и подышал(а) рядом — стало теплее.",
        "☕ | {actor} обнял(а) {target} покрепче и согрел(а) своим теплом.",
        "🌡 | {actor} согрел(а) {target} — тот(та) явно оттаял(а).",
    ),
    "invitedance": (
        "💃 | {actor} протянул(а) руку {target}: «Разрешите на танец?»",
        "🕺 | {actor} пригласил(а) {target} на танец с достоинством.",
        "🎶 | {actor} склонился(ась) перед {target} в изящном приглашении на танец.",
        "💃 | {actor} и {target} вышли на танцпол — публика расступилась.",
    ),
    "dickwave": (
        "🌊 | {actor} достал(а) член перед {target} и начал(а) неторопливо дрочить.",
        "💦 | {actor} помахал(а) членом в лицо {target}, и тот(та) не смог(ла) отвести взгляд.",
        "🫣 | {actor} прижал(а) голый член к щеке {target}. Чат наблюдает.",
        "🌀 | {actor} водил(а) членом по губам {target}, пока тот(та) не открыл(а) рот.",
        "💦 | {actor} натёр(ла) член об лицо {target} с нескрываемым удовольствием.",
        "🔞 | {actor} шлёпнул(а) {target} членом по щеке и остался(ась) доволен(довольна).",
    ),
    "shoot": (
        "🔫 | {actor} расстрелял(а) {target} в упор. Только рофл, без последствий.",
        "💥 | {actor} выпустил(а) обойму в {target} и сдул(а) дымок с дула.",
        "🎯 | {actor} хладнокровно расстрелял(а) {target} — идеальное попадание.",
    ),
    "finish": (
        "☠️ | {actor} добил(а) {target} контрольным.",
        "🗡 | {actor} не дал(а) {target} шанса и добил(а) на месте.",
        "💀 | {actor} эффектно добил(а) {target}, поставив жирную точку.",
    ),
    "down": (
        "🛬 | {actor} подбил(а) {target}, и тот(та) рухнул(а) вниз.",
        "💥 | {actor} метким выстрелом подбил(а) {target}.",
        "🎯 | {actor} подбил(а) {target} на взлёте — красиво и жёстко.",
    ),
    "drown": (
        "🌊 | {actor} утопил(а) {target} в чате обидных смайликов и в реке заодно.",
        "💧 | {actor} держал(а) {target} под водой, пока тот(та) не пошёл(шла) пузырями.",
        "🌊 | {actor} утащил(а) {target} на дно без права на апелляцию.",
    ),
    "booze": (
        "🍺 | {actor} сел(а) бухать с {target} — вечер обещает быть долгим.",
        "🥂 | {actor} разлил(а) по стаканам и бухнул(а) с {target} до утра.",
        "🍻 | {actor} чокнулся(ась) с {target} и понеслась душа в разгул.",
    ),
    "capture": (
        "⛓ | {actor} пленил(а) {target} и увёл(а) в неизвестном направлении.",
        "🏴 | {actor} взял(а) {target} в плен без единого выстрела.",
        "🔗 | {actor} пленил(а) {target} — теперь тот(та) в его(её) власти.",
    ),
    "thrust": (
        "😳 | {actor} присунул(а) {target} без предупреждения и без пауз.",
        "🔥 | {actor} резко присунул(а) {target}, и тот(та) охнул(а).",
        "🔞 | {actor} присунул(а) {target} по самое не могу, не сбавляя темпа.",
    ),
    "pray": (
        "🙏 | {actor} упал(а) на колени и помолился(ась) на {target}.",
        "✨ | {actor} сложил(а) руки и вознёс(ла) молитву {target}.",
        "🕯 | {actor} зажёг(ла) свечу и помолился(ась) на {target} как на икону.",
    ),
    "roast": (
        "🔥 | {actor} зажарил(а) {target} на вертеле — только шутки, без жертв.",
        "🍗 | {actor} обжарил(а) {target} со всех сторон до золотистой корочки.",
        "🔥 | {actor} закинул(а) {target} на угли и присматривал(а) за прожаркой.",
    ),
    "rinse": (
        "🚿 | {actor} промыл(а) {target} с ног до головы.",
        "💦 | {actor} окатил(а) {target} из шланга и заодно промыл(а) мозги.",
        "🧼 | {actor} тщательно промыл(а) {target} — теперь чистый(ая) как стёклышко.",
    ),
    "squeezebutt": (
        "🍑 | {actor} пожамкал(а) попу {target} без спроса.",
        "😳 | {actor} ущипнул(а) и пожамкал(а) попу {target}, пока тот(та) не отреагировал(а).",
        "🔞 | {actor} обеими руками пожамкал(а) попу {target} с явным удовольствием.",
    ),
    "squish": (
        "🫳 | {actor} пожмякал(а) {target} со всех сторон.",
        "🤏 | {actor} игриво пожмякал(а) щёки {target}.",
        "🫶 | {actor} пожмякал(а) {target}, будто тот(та) — плюшевая игрушка.",
    ),
    "rend": (
        "🩸 | {actor} растерзал(а) {target} без капли жалости.",
        "🗡 | {actor} разорвал(а) {target} в клочья — только рофл.",
        "💥 | {actor} безжалостно растерзал(а) {target} на глазах у всех.",
    ),
    "tie": (
        "🪢 | {actor} связал(а) {target} по рукам и ногам.",
        "⛓ | {actor} крепко связал(а) {target} — не вырваться.",
        "🔞 | {actor} связал(а) {target} и оставил(а) на его(её) усмотрение, что делать дальше.",
    ),
    "takeaway": (
        "🚶 | {actor} увёл(увела) {target} прямо у всех на глазах.",
        "💨 | {actor} незаметно увёл(увела) {target} из-под носа у остальных.",
        "🏃 | {actor} схватил(а) {target} за руку и увёл(увела) без объяснений.",
    ),
    "oralsupport": (
        "🔞 | {actor} опустился(лась) перед {target} и оказал(а) оральную поддержку без лишних слов.",
        "🔥 | {actor} провёл(вела) для {target} оральную поддержку, не отрываясь до самого конца.",
        "😳 | {actor} встал(а) на колени и оказал(а) {target} оральную поддержку по полной программе.",
    ),
    "analsupport": (
        "🔞 | {actor} провёл(вела) для {target} анальную поддержку, не сбавляя темпа.",
        "🔥 | {actor} оказал(а) {target} анальную поддержку так, что тот(та) вцепился(лась) в простыню.",
        "😳 | {actor} медленно, но уверенно оказал(а) {target} анальную поддержку.",
    ),
}
