...
_SOCIAL_ACTION_TEMPLATES: dict[str, tuple[str, ...]] = {
    ...
    "bend": (
        "😏 | {actor} нагнул(а) {target}.",
        "😏 | {actor} поставил(а) {target} в очень неловкое 18+ положение.",
        "😏 | {actor} устроил(а) для {target} слишком взрослую сцену.",
        "😏 | {actor} явно перегнул(а) градус близости с {target}.",
    ),
    "kneel": (
        "🛐 | {actor} поставил(а) {target} на колени.",
        "🛐 | {actor} заставил(а) {target} опуститься на колени без лишних разговоров.",
        "🛐 | {actor} прижал(а) {target} к полу и поставил(а) на колени.",
        "🛐 | {actor} устроил(а) для {target} очень унизительную сцену с коленями.",
    ),
    "undress": (
        "🫦 | {actor} медленно раздел(а) {target}.",
        "🫦 | {actor} оставил(а) {target} без одежды и без лишних вопросов.",
        "🫦 | {actor} устроил(а) {target} очень откровенное разоблачение.",
        "🫦 | {actor} так ловко раздел(а) {target}, что воздух в чате стал горячее.",
    ),
    "ravage": (
        "🔞 | {actor} жёстко выебал(а) {target}.",
        "🔞 | {actor} выебал(а) {target} так, что остальное уже неважно.",
        "🔞 | {actor} устроил(а) {target} настолько грязный секс, что чат притих.",
        "🔞 | {actor} без церемоний выебал(а) {target} и даже не сбавил(а) темп.",
    ),
    "hit": (
    ...
    "take": (
        "🔞 | {actor} жёстко взял(а) {target}.",
        "🔞 | {actor} подмял(а) под себя {target} и просто взял(а), как захотел(а).",
        "🔞 | {actor} без лишних церемоний взял(а) {target} под полный контроль.",
        "🔞 | {actor} так уверенно взял(а) {target}, что сопротивление даже не обсуждалось.",
    ),
    "have": (
        "🔞 | {actor} поимел(а) {target}.",
        "🔞 | {actor} грубо и без сантиментов поимел(а) {target}.",
        "🔞 | {actor} устроил(а) {target} такой взрослый эпизод, что детали лучше не расшифровывать.",
        "🔞 | {actor} просто взял(а) и поимел(а) {target}, не оставив места для нежностей.",
    ),
    "impale": (
        "🔞 | {actor} насадил(а) {target}.",
        "🔞 | {actor} поймал(а) {target} в такой позе, что дальше всё стало слишком очевидно.",
        "🔞 | {actor} жёстко насадил(а) {target}, задав совсем не романтичный темп.",
        "🔞 | {actor} так резко насадил(а) {target}, что воздух вокруг стал гуще.",
    ),
    "trap": (
        "🔞 | {actor} зажал(а) {target}.",
        "🔞 | {actor} загнал(а) {target} в тесную близость без шанса вывернуться.",
        "🔞 | {actor} плотно зажал(а) {target}, не оставив(ши) ни пространства, ни оправданий.",
        "🔞 | {actor} вжал(а) {target} в себя так, будто отпускать уже не собирался(ась).",
    ),
    "floor": (
        "🔞 | {actor} завалил(а) {target}.",
        "🔞 | {actor} опрокинул(а) {target} и быстро перевёл(вела) всё в совсем взрослую плоскость.",
        "🔞 | {actor} жёстко завалил(а) {target}, перехватив(ши) весь контроль себе.",
        "🔞 | {actor} так резко завалил(а) {target}, что темп события изменился мгновенно.",
    ),
    "spread": (
        "🔞 | {actor} разложил(а) {target}.",
        "🔞 | {actor} развернул(а) {target} именно так, как было удобно только ему(ей).",
        "🔞 | {actor} бесстыдно разложил(а) {target} для продолжения без лишней прелюдии.",
        "🔞 | {actor} устроил(а) {target} очень откровенную раскладку по взрослым правилам.",
    ),
    "gang": (
        "🔞 | {actor} пустил(а) {target} по кругу.",
        "🔞 | {actor} превратил(а) {target} в центр совсем грязного взрослого сценария.",
        "🔞 | {actor} закрутил(а) для {target} такой круговорот тел, что чат предпочёл отвернуться.",
        "🔞 | {actor} устроил(а) {target} коллективное приключение без тени нежности.",
    ),
    "banghard": (
        "🔞 | {actor} жёстко оттрахал(а) {target}.",
        "🔞 | {actor} выдал(а) {target} такую еблю, что после неё говорить уже нечего.",
        "🔞 | {actor} оттрахал(а) {target} с упором на грубый темп и полное доминирование.",
        "🔞 | {actor} не щадя сил оттрахал(а) {target}, не оставив шанса на передышку.",
    ),
    "shovein": (
        "🔞 | {actor} грубо засадил(а) {target}.",
        "🔞 | {actor} засадил(а) {target} так резко, что всё остальное стало вторичным.",
        "🔞 | {actor} без предупреждения вошёл(вошла) в {target} на слишком жёстком уровне.",
        "🔞 | {actor} устроил(а) {target} максимально прямолинейный и грубый заход.",
    ),
    "suck": (
    ...
    "dickwave": (
        "🌊 | {actor} поводил(а) членом перед {target}. {target} сохраняет спокойствие.",
        "💦 | {actor} решил(а) произвести впечатление на {target} нестандартным методом.",
        "🫣 | {actor} продемонстрировал(а) {target} нечто неожиданное. Чат притих.",
        "🌀 | {actor} исполнил(а) перед {target} классику жанра. Оценки расходятся.",
    ),
}
